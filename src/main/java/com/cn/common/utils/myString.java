...
public class myString {
    ...
    **/
     ...
     * @return java.lang.String
    **/
    public static String base64Encode(String pwd) throws UnsupportedEncodingException {
    ...
    **/
     ...
     * @return java.lang.String
    **/
    public  static  String MD5Encode(String pwd) throws NoSuchAlgorithmException {
